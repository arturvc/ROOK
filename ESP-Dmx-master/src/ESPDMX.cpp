...
//int sendPin = 10;		//default on DOIT ESP32 DEVKIT
...
void DMXESPSerial::init(int pinNumber) {
  chanSize = defaultMax;
  sendPin = pinNumber;
...
void DMXESPSerial::init(int pinNumber, int chanQuant) {
...
uint8_t DMXESPSerial::read(int Channel) {
  if (dmxStarted == false) init(sendPin);
